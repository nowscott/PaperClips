            ...
            <div className="flex flex-col gap-8">
              ...
              <section>
                <h3 className="text-lg font-bold text-evolve-accent mb-3 flex items-center gap-2">
                  <span>💾 存档管理 (Save Management)</span>
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  >
                    ...
                    <span className="text-sm">硬重置 (Hard Reset)</span>
                  </button>
                </div>
              ...
              <section>
                ...
                <div className="text-sm text-evolve-textMain space-y-4 leading-relaxed bg-evolve-border/20 p-4 rounded">
                  ...
                  <div className="space-y-2">
                    <h4 className="font-bold text-evolve-textMain border-b border-evolve-border pb-1">阶段一：手动积累 (Early Game)</h4>
                    <ul className="list-disc pl-5 text-evolve-textDim space-y-1">
                      <li>点击“制造回形针”按钮。</li>
                      <li>根据公众需求 (Public Demand) 调整价格：价格越低，卖得越快；营销等级越高，需求越高。</li>
                      <li>积攒资金购买“自动制造机 (AutoClippers)”来解放双手。</li>
                      <li>时刻关注铁丝 (Wire) 的成本波动，低价时进货！</li>
                    </ul>
                  </div>

                  <div className="space-y-2">
                    <h4 className="font-bold text-evolve-textMain border-b border-evolve-border pb-1">阶段二：计算与算力 (Mid Game)</h4>
                    <ul className="list-disc pl-5 text-evolve-textDim space-y-1">
                      <li>随着总产量提升，你将获得“信任值 (Trust)”。将它们分配给“处理器 (Processors)”来生成算力 (Ops)，或者“内存 (Memory)”来提高算力上限。</li>
                      <li>使用算力解锁强大的科研项目 (Projects)，比如自动进货、更高效的制造机，甚至开启量子计算。</li>
                    </ul>
                  </div>

                  <div className="space-y-2">
                    <h4 className="font-bold text-evolve-textMain border-b border-evolve-border pb-1">阶段三：巨型工业与博弈 (Late-Mid Game)</h4>
                    <ul className="list-disc pl-5 text-evolve-textDim space-y-1">
                      <li>解锁创造力 (Creativity)，解决哲学与数学难题。</li>
                      <li>运行“策略锦标赛 (Tournaments)”获取 Yomi，以此解锁最高级的黑科技。</li>
                      <li>地球的铁丝终有耗尽的一天。你必须建造“采集无人机”和“回形针工厂”直接从地球物质中提取资源。</li>
                    </ul>
                  </div>

                  <div className="space-y-2">
                    <h4 className="font-bold text-evolve-textMain border-b border-evolve-border pb-1">阶段四：太空与蜂群 (End Game)</h4>
                    <ul className="list-disc pl-5 text-evolve-textDim space-y-1">
                      <li>发射冯·诺依曼探测器前往宇宙。</li>
                      <li>合理分配探测器的点数（复制、探索、危险防护）。小心那些因为价值对齐失败而变异的“漂流者 (Drifters)”，你需要点出战斗 (Combat) 属性来对抗它们。</li>
